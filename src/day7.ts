    ...
    _step() {
        ...
        switch (op) {
            case 99:
                ...
                break
            case 1:
                this.program[this.program[this.p + 3]] = this._param(1) + this._param(2)
                skip = 4
                break
            case 2:
                this.program[this.program[this.p + 3]] = this._param(1) * this._param(2)
            ...
            case 6:
                ...
                break
            case 7:
                this.program[this.program[this.p + 3]] = this._param(1) < this._param(2) ? 1 : 0
                skip = 4
                break
            case 8:
                this.program[this.program[this.p + 3]] = this._param(1) == this._param(2) ? 1 : 0
...
const amplifiers = [new Computer(code), new Computer(code), new Computer(code), new Computer(code), new Computer(code)]
