...
export default class Day16 extends Command {
    // 80284420
    async run() {
        let input =
        ...
        // Part 1
        let t = new Transmission(input, 1);
        for (let i = 0; i < 100; i++) {
            t.encode();
        }
